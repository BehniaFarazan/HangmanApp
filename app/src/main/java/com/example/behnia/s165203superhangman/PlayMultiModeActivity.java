...
public class PlayMultiModeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void updateDisplay() {
        ...
        switch (mylogic.getThisIsnrWrongGuess()) {
            ...
            case 6:
                ...
                Intent i = new Intent(PlayMultiModeActivity.this, LostActivity.class);
                startActivity(i);
                break;
        }
    }
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        Intent i = new Intent(PlayMultiModeActivity.this, MainMenu.class);
                        startActivity(i);
                    }
                }).create().show();
    }
